...
export default function TermsPage() {
  const pageData = getLegalPage('terms-of-service');
    ...
    <div className="flex min-h-screen flex-col">
      <section className="bg-green-800 py-12 text-cream">
        <Container width="reading">
          <h1 className="text-display-lg font-display mb-4">Terms & Conditions</h1>
      ...
      <section className="pb-24">
        <Container width="reading">
          <div className="mb-12 p-4 bg-sun-500/10 border-l-4 border-sun-500 text-ink">
            <strong>Warning:</strong> This terms and conditions document is a placeholder and requires review by qualified legal counsel before publication.
          </div>
